...
`<p
 ...
 style="position:absolute; background-color:#ff0000;"
 title="A title attribute">
</p>`
...
test(`The wrap fn should produce shortcut functions that generate \
the same valid html as the hyperscript function itself.`, function (t) {
  let {article, h1, p, span} = wrap({article: 'article', h1: 'h1', p: 'p', span: 'span'})
  let lipsum = 'Cupcake ipsum dolor sit amet fruitcake tart. Brownie icing jelly-o cake. Jelly cotton candy sweet roll candy cheesecake pudding lollipop jelly dessert.'
  let expect =
`<article
 class="foo bar bar baz"
